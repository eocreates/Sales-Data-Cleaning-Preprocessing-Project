...
- [**Project Overview**](#Project-Overview)
 ...
 - [**Data Cleaning Process**](#Data-Cleaning-Process)
    ...
    - [Handling NULL and Missing Values](#2-Handling-NULL-and-Missing-Values)
    - [Standardizing Numeric Columns](#3-Standardizing-Numeric-Columns)
    - [Standardizing Dates](#4-Standardizing-Dates)
    - [Standardizing Categorical Columns](#5-Standardizing-Categorical-Columns)
    - [Standardizing State & City](#6-Standardizing-State--City)
    - [Creating Fullname Columns](#7-Creating-Fullname-Columns)
    - [Duplicate Detection](#8-Duplicate-Detection)
